...
* **Optimal Remediation:** Application of an empirical **Box-Cox Transformation ($\lambda \approx 3.55$)** stabilized residual variance and normalized error distribution, significantly improving model goodness-of-fit and parameter reliability.
